...
// Print the headings to the SD card file
  String message = "ReadingID, dayStamp, timeStamp, ADC0, ADC1, ADC2, ADC3, ADC4, ADC5, ADC6, ADC7";  
...
void logSDCard() {
  ...
  storeDataToSDCard(SD, "/data.txt", dataMessage.c_str());
}
